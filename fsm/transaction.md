...
- The created block height must be within an acceptable range of the current height (±4320 blocks). Assuming 5s block times, this is roughly 6 hours and allows safe pruning of old transaction data.
