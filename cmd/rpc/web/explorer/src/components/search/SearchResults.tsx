                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-2 mt-4">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                                ...
                                {loading ? (
                                    ...
                                    <span className="text-white text-sm">{balance} PROOF</span>
                                )}
                            </div>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
        ...
        const configs = {
                ...
                fields: [
                    ...
                    { label: 'Type:', value: item.messageType || item.type || 'Transfer' },
                    {
                        label: 'Amount:', value: typeof (item.amount ?? item.value ?? 0) === 'number' ?
                            `${(item.amount ?? item.value ?? 0).toFixed(3)} PROOF` :
                            `${item.amount ?? item.value ?? 0} PROOF`
                    },
            ...
            validator: {
                ...
                fields: [
                    ...
                    { label: 'Stake:', value: `${(item.stakedAmount / 1000000).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} PROOF` },
