            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option>PROOF/ETH</option>
                        <option>PROOF/BTC</option>
                        <option>PROOF/SOL</option>
                        <option>PROOF/USDC</option>
                        <option>PROOF/AVAX</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        <option>Buy PROOF</option>
                        <option>Sell PROOF</option>
                    </select>
                </div>
