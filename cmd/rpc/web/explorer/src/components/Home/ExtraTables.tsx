...
const ExtraTables: React.FC = () => {
    ...
    const allChains = txs.map((t: any) => t.chain || 'ProofArcade')
    const allCanopy = allChains.every((chain: string) => chain === 'ProofArcade' || !chain)
            ...
            return [
                ...
                <span className="text-gray-200">
                    {typeof totalWeight === 'number' ? (
                        ...
                        totalWeight ? `${(Number(totalWeight) / 1000000).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 6 })} PROOF` : '0 PROOF'
                    )}
                </span>,
                <span className="text-gray-200">
                    {typeof stake === 'number' ? (
                        ...
                        stake ? `${(Number(stake) / 1000000).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 6 })} PROOF` : '0 PROOF'
                    )}
                </span>,
                <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 gap-6">
            ...
            <TableCard
                ...
                rows={txs.map((t: any) => {
                    ...
                    const chain = t.chain || 'ProofArcade'
                    ...
                    const baseRow = [
                        ...
                        <span className="text-primary">
                            {typeof amount === 'number' ? (
                                ...
                                <span className="text-primary">{amount !== 'N/A' ? `${(Number(amount) / 1000000).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 6 })} PROOF` : 'N/A'}</span>
                            )}
                        </span>,
